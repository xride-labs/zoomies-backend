  ...
  const adminUser = await createUserWithRoles(
    {
      ...
      bloodType: "O+",
      avatar: "https://res.cloudinary.com/xride-labs/image/upload/v1772386875/zoomies/rides/avatar_hgoxkz.jpg",
      coverImage: "https://res.cloudinary.com/xride-labs/image/upload/v1772387502/zoomies/rides/bannerBackgroundImage_o8qnzwji8ckd1_rynbjl.png",
      xpPoints: 5200,
      level: 12,
  ...
  const user1 = await createUserWithRoles(
    {
      ...
      bloodType: "B+",
      avatar: "https://res.cloudinary.com/xride-labs/image/upload/v1772560334/zoomies/rides/male_doctor_njjg5j.png",
      coverImage: "https://res.cloudinary.com/xride-labs/image/upload/v1772560334/zoomies/rides/119419735_udtbgq.webp",
      xpPoints: 1200,
      level: 5,
  ...
  const user2 = await createUserWithRoles(
    {
      ...
      bloodType: "A+",
      avatar: "https://res.cloudinary.com/xride-labs/image/upload/v1772560335/zoomies/rides/Police_Woman_h2lvlq.png",
      coverImage: "https://res.cloudinary.com/xride-labs/image/upload/v1772560336/zoomies/rides/IMG_6600_t57x4d.webp",
      xpPoints: 2500,
      level: 8,
